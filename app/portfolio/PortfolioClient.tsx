  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-200 selection:bg-sky-500/30 font-light overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 space-y-24 md:space-y-40 lg:space-y-60 pb-20 md:pb-40">
         ...
         {/* 5. EDUCATION - Upgraded Visuals */}
         <section>
            <div className="p-5 sm:p-10 md:p-20 bg-white/5 backdrop-blur-3xl rounded-[2.5rem] md:rounded-[5rem] border border-white/10 w-full relative overflow-hidden group/box">
                <div className="absolute -top-24 -right-24 w-64 h-64 md:w-96 md:h-96 bg-sky-500/20 blur-[100px] rounded-full group-hover/box:bg-sky-500/30 transition-colors duration-1000" />
                
                <div className="flex items-center gap-4 md:gap-6 mb-12 md:mb-24 relative">
                  <div className="p-3 md:p-4 bg-sky-500 rounded-2xl border border-sky-400/50 shrink-0 shadow-[0_0_20px_rgba(14,165,233,0.4)]">
                      <GraduationCap className="text-black w-8 h-8 md:w-12 md:h-12" />
                  </div>
                  <h2 className="text-3xl sm:text-5xl md:text-7xl font-black italic uppercase tracking-tighter leading-none">
                      Academic Journey.
                  </h2>
                ...
                <div className="space-y-16 md:space-y-32 relative">
                  <div className="absolute left-0 md:left-12 top-0 bottom-0 w-[1px] md:w-[2px] bg-gradient-to-b from-sky-500 via-sky-500/20 to-transparent" />
                  
                  {educations.map((edu) => (
                      <div key={edu.id} className="relative pl-10 md:pl-32 group">
                          <div className="absolute left-[-4.5px] md:left-[43px] top-2 w-2.5 h-2.5 md:w-4 md:h-4 rounded-full bg-sky-500 shadow-[0_0_15px_rgba(14,165,233,1)] z-10 transition-transform group-hover:scale-150" />
                          
                          <div className="flex flex-col gap-6 md:gap-10">
                              <div className="flex flex-col lg:flex-row lg:items-start gap-6 lg:gap-10">
                                <div className="relative w-16 h-16 sm:w-20 sm:h-20 md:w-32 md:h-32 shrink-0 bg-white/10 rounded-2xl md:rounded-[2.5rem] overflow-hidden border border-white/10 shadow-xl group-hover:border-sky-500/30 transition-all">
                                    {edu.logo_url ? (
                                        <Image src={edu.logo_url as string} alt={edu.name} fill className="object-contain p-2 md:p-4 transition-transform duration-700 group-hover:scale-110" />
                                    ) : (
                                        <div className="w-full h-full flex items-center justify-center opacity-20"><GraduationCap size={32}/></div>
                                    )}
                                </div>
                                ...
                                <div className="flex-1 min-w-0 space-y-3 md:space-y-5">
                                    <div className="flex flex-wrap items-center gap-3">
                                        <span className="inline-block text-sky-400 font-black tracking-[0.2em] text-[10px] md:text-sm uppercase bg-sky-500/10 px-4 py-1.5 rounded-full border border-sky-500/20 shadow-[0_0_15px_rgba(14,165,233,0.1)]">
                                        {new Date(edu.starttime).getFullYear()} — {edu.endtime ? new Date(edu.endtime).getFullYear() : 'PRESENT'}
                                        </span>
                                    </div>
                                    <h4 className="text-2xl sm:text-[2.5rem] md:text-6xl font-black uppercase italic leading-none text-white tracking-tighter group-hover:text-sky-400 transition-colors">
                                      {edu.name}
                                    </h4>
                                    <p className="text-white/40 text-sm sm:text-xl md:text-2xl font-medium italic leading-relaxed max-w-2xl">
                                      {edu.faculty}
                              ...
                              {edu.GPAX && (
                              <div className="relative self-start mt-2 sm:mt-4 group/gpax">
                                  <div className="absolute inset-0 bg-sky-500 blur-[40px] opacity-0 group-hover/gpax:opacity-20 transition-opacity" />
                                  <div className="relative flex items-baseline gap-2 md:gap-5">
                                  <span className="text-6xl sm:text-7xl md:text-[9rem] lg:text-[11rem] font-black text-white italic tracking-tighter leading-none drop-shadow-[0_10px_30px_rgba(255,255,255,0.1)] group-hover/gpax:text-sky-500 transition-colors">
                                      {edu.GPAX}
                                  </span>
                                  <div className="flex flex-col">
                                      <span className="text-sky-400 font-black text-sm sm:text-base md:text-3xl italic leading-none">GPAX</span>
                                      <span className="text-white/20 text-[8px] md:text-[12px] font-bold uppercase tracking-widest">Merit Limit</span>
                                  </div>
                                  </div>
                              </div>
                              )}
         ...
         {/* 6. PERSONAL SKILLS - Glowing Borders */}
         <section>
            <div className="p-8 md:p-20 bg-emerald-500/5 rounded-[3rem] md:rounded-[5rem] border border-emerald-500/10 relative overflow-hidden group/skills">
               <div className="absolute -bottom-24 -left-24 w-64 h-64 md:w-96 md:h-96 bg-emerald-500/10 blur-[100px] rounded-full" />
               <div className="flex items-center gap-4 md:gap-6 mb-12 md:mb-24 relative">
                  <div className="p-3 md:p-4 bg-emerald-500 rounded-2xl shadow-[0_0_20px_rgba(16,185,129,0.4)]">
                    <Zap className="text-black w-8 h-8 md:w-16 md:h-16"/>
                  </div>
                  <h2 className="text-4xl md:text-6xl font-black italic uppercase tracking-tighter">Personal Skill.</h2>
               </div>
               <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 relative">
                  {softSkills.map((skill) => (
                    <div key={skill.id} className="group/item relative p-8 md:p-10 bg-white/5 rounded-3xl md:rounded-[3rem] border border-white/5 transition-all duration-500 hover:scale-[1.02] hover:bg-emerald-500 overflow-hidden">
                      ...
                      <div className="relative z-10 flex flex-col gap-4 md:gap-6 group-hover/item:text-black transition-colors">
                         <CheckCircle2 size={32} className="text-emerald-400 group-hover/item:text-black transition-colors" />
                         <span className="text-lg md:text-xl font-black uppercase tracking-widest leading-tight">{skill.name}</span>
                      </div>
                    </div>
                  ))}
               </div>
         ...
         {/* 7. TECH UNIVERSE - Fixed & Enhanced */}
         <section className="py-12 relative overflow-hidden">
            <div className="relative mb-16 md:mb-32 px-4 overflow-hidden h-[10rem] sm:h-[15vw] lg:h-[12rem]">
                <div className="relative flex justify-center items-center h-full">
                    ...
                    <motion.h2 
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        className="text-6xl sm:text-[10vw] lg:text-[11rem] font-black tracking-tighter text-center italic uppercase leading-none bg-gradient-to-t from-sky-500 via-white to-white bg-clip-text text-transparent drop-shadow-[0_0_30px_rgba(14,165,233,0.5)]"
                    >
                        Tech Universe.
                    </motion.h2>
                </div>
         ...
         {/* 8. PROJECTS - Enhanced Rounded & Hover */}
         <section>
            <div className="mb-20 md:mb-40 text-center px-4 relative">
                ...
                >
                    Selected <br /> 
                    <span className="text-slate-800 inline-block hover:text-sky-500 transition-colors duration-500">Portfolio</span>
                </motion.h2>
            ...
            <div className="space-y-24 md:space-y-60">
                {projects.map((project, idx) => (
                <div key={project.id} onClick={() => setSelectedProject(project)} className={`flex flex-col ${idx % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-8 lg:gap-16 items-center cursor-pointer group`}>
                    <div className="w-full lg:w-1/2 aspect-video md:aspect-[16/10] overflow-hidden relative rounded-[2rem] md:rounded-[3.5rem] border border-white/10 shadow-2xl transition-transform duration-700 group-hover:scale-[1.02]">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-sky-500/40 to-transparent opacity-0 group-hover:opacity-100 flex items-center justify-center transition-all duration-500">
                        <div className="bg-white text-black px-8 py-4 rounded-full font-black text-sm uppercase italic tracking-[0.2em] shadow-2xl transform translate-y-4 group-hover:translate-y-0 transition-transform">View Case Study</div>
                      </div>
                    </div>
                    <div className={`w-full lg:w-1/2 p-6 lg:p-10 space-y-4 md:space-y-8 ${idx % 2 === 0 ? 'text-left' : 'lg:text-right lg:items-end flex flex-col'}`}>
                      <div className="text-sky-500 font-black italic text-sm md:text-base tracking-[0.3em] flex items-center gap-4">
                        <span className="w-8 h-[1px] bg-sky-500" /> 0{idx + 1} / {projects.length}
                      </div>
                      <h3 className="text-5xl md:text-7xl font-black italic uppercase leading-none tracking-tighter group-hover:text-sky-400 transition-colors">{project.title}</h3>
                      <p className="text-white/30 italic text-lg md:text-2xl font-light leading-relaxed line-clamp-3 md:line-clamp-none">&quot;{project.content}&quot;</p>
                      <div className="pt-4 flex gap-4">
                         <div className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center group-hover:border-sky-500 group-hover:text-sky-500 transition-all">
      ...
      <footer className="py-20 md:py-40 px-6 border-t border-white/5 bg-black/60 text-center relative overflow-hidden">
          ...
          <p className="text-[10px] md:text-[12px] font-black uppercase tracking-[1em] md:tracking-[2.5em] opacity-10">
             © 2026 {profile?.firstname} {profile?.lastname}
          </p>
      </footer>

      {/* 10. MODAL - (Unchanged structure, only visual tweaks) */}
      <AnimatePresence>
        {selectedProject && (
          <motion.div 
            initial={{ opacity: 0 }} 
                ...
                <div className="space-y-10">
                  <div className="p-8 bg-white/5 rounded-[2rem] border border-white/10 space-y-8">
                    ...
                    <div className="pt-8 border-t border-white/10 grid grid-cols-2 gap-4 text-[10px] font-black uppercase tracking-widest italic">
                      ...
                      <div className="text-white/80 text-right">{selectedProject.employmentType}</div>
                      <div className="text-white/20">Status</div>
                      <div className="text-sky-500 text-right font-black shadow-sky-500/50">{selectedProject.status}</div>
                    </div>
                  </div>
                </div>
              </div>
